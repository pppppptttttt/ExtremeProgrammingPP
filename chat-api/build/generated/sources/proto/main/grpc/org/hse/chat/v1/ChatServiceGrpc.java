...
@javax.annotation.Generated(
    ...
    comments = "Source: org/hse/chat/v1/chat.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class ChatServiceGrpc {

  private ChatServiceGrpc() {}

  public static final java.lang.String SERVICE_NAME = "org.hse.chat.v1.ChatService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.hse.chat.v1.ChatMessage,
      org.hse.chat.v1.ChatMessage> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Chat",
      requestType = org.hse.chat.v1.ChatMessage.class,
      responseType = org.hse.chat.v1.ChatMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<org.hse.chat.v1.ChatMessage,
      org.hse.chat.v1.ChatMessage> getChatMethod() {
    io.grpc.MethodDescriptor<org.hse.chat.v1.ChatMessage, org.hse.chat.v1.ChatMessage> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod =
              io.grpc.MethodDescriptor.<org.hse.chat.v1.ChatMessage, org.hse.chat.v1.ChatMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.hse.chat.v1.ChatMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     * <pre>
     * Дуплексный обмен: оба peer-а шлют поток сообщений друг другу.
     * </pre>
     */
    default io.grpc.stub.StreamObserver<org.hse.chat.v1.ChatMessage> chat(
        io.grpc.stub.StreamObserver<org.hse.chat.v1.ChatMessage> responseObserver) {
  ...
  public static final class ChatServiceStub
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<org.hse.chat.v1.ChatMessage> chat(
        io.grpc.stub.StreamObserver<org.hse.chat.v1.ChatMessage> responseObserver) {
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.hse.chat.v1.ChatProto.getDescriptor();
    }
